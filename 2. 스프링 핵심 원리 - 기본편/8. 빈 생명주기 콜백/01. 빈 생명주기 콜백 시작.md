...
public class BeanLifeCycleTest {
    ...
    static class LifeCycleConfig {
        ...
        public NetworkClient networkClient() {
            NetworkClient networkClient = new NetworkClient(); //스프링 빈 객체 생성
            networkClient.setUrl("http://hello-spring.dev"); //의존관계(수정자) 주입
...
따라서, 생성자 부분을 보면 url 정보 없이 connect가 호출된 것이다.
...
수정자 주입과 필드 주입은 '스프링 빈 생성 → 의존관계 주입' 순서를 따르지만,
생성자 주입은 '스프링 빈 생성' 시점에 '의존관계 주입'이 일어난다.
